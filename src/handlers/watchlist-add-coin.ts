...
composer.callbackQuery("watchlist:add_coin", async (ctx) => { await ctx.answerCallbackQuery(); await ctx.reply("Выберите монету или введите другой тикер.", { reply_markup: seeds }); });
